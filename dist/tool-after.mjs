...
function overridesPath() {
  return join18(runtimeHome(), "model-prices.json");
}
function providerNativePath(provider) {
  return join18(runtimeHome(), `model-prices.${provider}.json`);
}
function litellmPath() {
  return join18(runtimeHome(), "model-prices.litellm.json");
}
function aliasesPath() {
  return join18(runtimeHome(), "model-aliases.json");
}
