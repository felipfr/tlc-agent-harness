...
function overridesPath() {
  return join21(runtimeHome(), "model-prices.json");
}
function providerNativePath(provider) {
  return join21(runtimeHome(), `model-prices.${provider}.json`);
}
function litellmPath() {
  return join21(runtimeHome(), "model-prices.litellm.json");
}
function aliasesPath() {
  return join21(runtimeHome(), "model-aliases.json");
}
