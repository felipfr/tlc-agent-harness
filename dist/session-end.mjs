...
import { existsSync as existsSync24, mkdirSync as mkdirSync15, readFileSync as readFileSync24, writeFileSync as writeFileSync14 } from "node:fs";
...
function renderClaudeLessonsView(root) {
  ...
  const existing = existsSync24(path) ? readFileSync24(path, "utf8") : "";
...
import { existsSync as existsSync25, mkdirSync as mkdirSync16, readFileSync as readFileSync25, writeFileSync as writeFileSync15 } from "node:fs";
...
function renderCursorLessonsView(root) {
  ...
  const body = readFileSync25(sourcePath, "utf8");
