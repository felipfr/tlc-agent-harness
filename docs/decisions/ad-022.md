...
Prove-safe misfires toward denial, and three of those misfires were real — each one caught by the gate
...
cross-segment attribution, and `echo '{}' > cfg` all still deny.
