...
migration: "The ship gate now refuses evidence written before the code it certifies, so a run that used to pass may block. Re-run your verification after the last code change, then cite the verdict."
