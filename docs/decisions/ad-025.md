...
migration: "If your config sets mode to heads-down, change it to focus — the old spelling now falls back to solo at load. Run tlc harness doctor; it names the file if you are affected."
