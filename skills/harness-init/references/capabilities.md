...
| 5 | Subagent allowlist | `subagents.enforceAllowlist` | off | Restricts Task models and blocks *-fast by default. | You must maintain allowedModels when Cursor adds models you want. | `allowedModels`, `requireModel`, `blockMode` |
